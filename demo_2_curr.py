...
# Initialize Opponent King Kills and User King Kills
...
def move_piece(selected_piece, col, row):
    global user_king_col, user_king_row, user_boat_col, user_boat_row
...
def remove_piece_with_animation(col, row):
    ...
    # After the animation, respawn the piece and update points
    pass
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                if selected_piece is not None:
                    if (col, row) in highlighted_squares:
                        ...
                        # Update user's score based on the type of piece moved
                        if selected_piece == (user_king_col, user_king_row):
                            user_points -= 10
                        elif selected_piece == (user_boat_col, user_boat_row):
                            user_points -= 20
